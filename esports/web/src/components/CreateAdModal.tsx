...
export function CreateAdModal() {
  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded w-[480px] shadow-black/25'>
        ...
        <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input name="name" id="name" type="text" placeholder='Selecione o game que deseja jogar' />
          </div>
          ...
          <div className="flex gap-6">
            ...
            <div className="flex flex-col gap-2 flex-1">
              <label htmlFor="hourStart">Qual seu hourStart?</label>
